                            ...
                            <fieldset>
                                ...
                                <div id="myPlayType">
                                    ...
                                    <div id="fullLoader" class="fullLoader" v-if="isFullLoading">
                                        <div class="loaderIMG">
                                            <img src="https://plab-football.s3.amazonaws.com/static/img/logo_grey.svg">
                                        </div>
                                    </div>
                                    <div class="inputWrap" v-if="myPlayStyle.level == null">
                                        <label>나의 실력</label>
                                        <div class="inputWrapper">
                                            <p @click="editPlayStyle = true" class="level--btn">Lv.[[ myPlayStyle.level
                                                ]]</p>
                                            <div v-if="matchLevel == 2">
                                                <span v-if="myPlayStyle.level < 3"><strong style="color: #FF5454">중급 매치는
                                                        Lv.3 이상 유저의 참여를 권장하고 있습니다.</strong> Lv.3 미만이라면 일반 매치 참여를, Lv.3
                                                    이상이라면 레벨 변경후 신청해주세요.</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="orderPay">
                            <fieldset class="payment">
                                ...
                                <div class="payRowWrap">
                                    ...
                                    <div>
                                        <div class="payRow" style="display: none">
                                            <span>매니저 프리</span>
                                            <p id="manager_free">-10,000원</p>
                                        </div>

                                        <div class="payRow" style="display: none">
                                            <span>멤버십</span>
                                            <p id="membership_cash">-10,000원</p>
                                        </div>

                                        <div class="payRow" style="display: block">
                                            <span id="coupon_title">쿠폰</span>
                                            <p id="selectModal" style="cursor: pointer">0개 보유 ></p>
                                        </div>
                                    </div>
